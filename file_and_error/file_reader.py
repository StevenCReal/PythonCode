# 打开文件
with open(r'file_and_error\pi_digits.txt') as file_object:      # 前面务必加上r
    contents = file_object.read()
    print(contents)

# 逐行读取
path_name = r'file_and_error\pi_digits.txt'
...
# 写入空文件
file_name =r"file_and_error\programming_message.txt"
